function [] = PreprocessDataSetPlus(topFocus, fullFocus, loc, imshow, num_each, num_test)
...
%         f_PCA_scale_test_normal=(vector_ori(:,:,scales)'*mean_subst_test(:,:,scales));        
    ...
    display 'finished.'
    save(['../PrepDataPOFA_Tr14_Te2.mat'],'preprocessedData')
    cd ..
end